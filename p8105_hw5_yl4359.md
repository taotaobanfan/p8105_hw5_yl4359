...
The sample average of estimated β<sub>1</sub> across tests for which the
null is rejected don’t approximately equal to the true value of
β<sub>1</sub>. Because the power is small when β<sub>1</sub> is less
than 6.
